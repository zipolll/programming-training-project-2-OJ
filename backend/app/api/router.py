...
from backend.app.modules.logs.router import router as logs_router
from backend.app.modules.logs.router import submission_log_router
from backend.app.modules.problem_banks.router import router as banks_router
...
api_router.include_router(banks_router, prefix="/problem-banks", tags=["problem-banks"])
